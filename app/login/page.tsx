    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 animate-slide-up">
          ...
          <h1 className="text-3xl font-serif font-black text-slate-800 mb-3">Welcome Back</h1>
          <p className="text-slate-600 leading-relaxed">Sign in to continue reducing food waste</p>
        </div>
